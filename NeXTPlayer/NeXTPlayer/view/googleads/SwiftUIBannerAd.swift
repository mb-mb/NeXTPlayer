...
public struct SwiftUIBannerAd: View {
    ...
    func setFrame(topInset: CGFloat = 0, bottomInset: CGFloat = 0) {
//        let safeAreaInsets = UIApplication.shared.windows.first(where: { $0.isKeyWindow })?.safeAreaInsets ?? .zero
        let frame = UIScreen.main.bounds.inset(by: UIEdgeInsets(top: topInset, left: 0, bottom: 200, right: 0))
