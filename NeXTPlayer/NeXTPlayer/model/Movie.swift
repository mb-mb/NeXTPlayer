...
struct Movie: Codable, Identifiable {
    ...
    static func example() -> Movie {
        let albumImage1 = makeFakeImageAlbum(index: 0)
        return Movie(wrapperType: "track", kind: "feature-movie", artistID: 1, trackID: 1,
                     artistName: "The Silent Ones",
                     trackName: "Screaming for Silence",
                     trackCensoredName: "", artistViewURL: nil, trackViewURL: "", previewURL: nil,
              artworkUrl30: albumImage1,
              artworkUrl60: albumImage1,
              artworkUrl100: albumImage1,
    ...
    static func example1() -> Movie {
        ...
        return Movie(wrapperType: "track", kind: "feature-movie", artistID: 2, trackID: 2,
                     artistName: "My Sound Romance",
                     trackName: "The Blue Parade",
                     trackCensoredName: "", artistViewURL: nil, trackViewURL: "", previewURL: nil,
              artworkUrl30: albumImage1,
              artworkUrl60: albumImage1,
              artworkUrl100: albumImage1,
    ...
    static func example2() -> Movie {
        ...
        return Movie(wrapperType: "track", kind: "feature-movie", artistID: 3, trackID: 3,
                     artistName: "Doomsday",
                     trackName: "he End of the World",
                     trackCensoredName: "", artistViewURL: nil, trackViewURL: "", previewURL: nil,
              artworkUrl30: albumImage1,
              artworkUrl60: albumImage1,
              artworkUrl100: albumImage1,
    ...
    static func examples() -> [Movie] {
        ...
        return [example(), example1(), example2()]
